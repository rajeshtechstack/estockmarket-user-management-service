...
public class AxonConfig {
    ...
    @Value("${spring.data.mongodb.database:users_db}")
    ...
    public MongoClient mongoClient(){
        ...
        mongoSettingsFactory.setMongoAddresses(Collections.singletonList(new ServerAddress(mongoDbHost, mongoDbPort)));
    ...
    public MongoTemplate axonMongoTemplate(){
        return DefaultMongoTemplate.builder().
                mongoDatabase(mongoClient(), mongoDatabase).build();
    }
    ...
    public EventStorageEngine eventStorageEngine(MongoClient mongoClient){
        return MongoEventStorageEngine.builder()
                ...
                .eventSerializer(JacksonSerializer.builder()
                        .defaultTyping()
                        .build())
                .snapshotSerializer(JacksonSerializer.builder()
                        .defaultTyping()
                        .build())
                .build();
    }
